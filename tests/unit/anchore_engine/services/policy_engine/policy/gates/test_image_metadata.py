...
def test_image_metadata_attribute_check_trigger(
    image_metadata_gate, image, exec_context, test_context
):
    attribute_check_trigger = image_metadata.ImageMetadataAttributeCheckTrigger(
        parent_gate_cls=image_metadata_gate.__class__, **test_context["trigger_params"]
    )
...
def test_invalid_rule_check(image_metadata_gate, image, exec_context, trigger_params):
    with pytest.raises(PolicyRuleValidationErrorCollection):
        image_metadata.ImageMetadataAttributeCheckTrigger(
            parent_gate_cls=image_metadata_gate.__class__, **trigger_params
        )
